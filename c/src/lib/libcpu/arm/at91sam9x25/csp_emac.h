...
#ifndef  CSP_EMAC_PRESENT
#define  CSP_EMAC_PRESENT
/*
*********************************************************************************************************
*                                            INCLUDE FILES
*********************************************************************************************************
...
* AT91SAM9X25_EMAC Ethernet MAC 10/100
*********************************************************************************************************
*/

#define CSP_EMAC_SA_NBR_MAX 4

#define CSP_EMAC_REG_BASE_ADDR_EMAC0                         (CPU_ADDR   )(0xF802C000U)      /* (EMAC0   ) Base Address */
#define CSP_EMAC_REG_BASE_ADDR_EMAC1                         (CPU_ADDR   )(0xF8030000U)      /* (EMAC1   ) Base Address */


/** \brief EmacSa hardware registers */
typedef struct {
  CPU_REG32   EMAC_SAxB;    /**< \brief (EmacSa Offset: 0x0) Specific Address 1 Bottom Register */
  CPU_REG32   EMAC_SAxT;    /**< \brief (EmacSa Offset: 0x4) Specific Address 1 Top Register */
} CSP_EMAC_SA_REG_TAG;
/** \brief Emac hardware registers */

typedef struct {
  CPU_REG32   EMAC_NCR;     /**< \brief (Emac Offset: 0x00) Network Control Register */
  CPU_REG32   EMAC_NCFGR;   /**< \brief (Emac Offset: 0x04) Network Configuration Register */
  CPU_REG32   EMAC_NSR;     /**< \brief (Emac Offset: 0x08) Network Status Register */
  CPU_REG32   Reserved1[2];
  CPU_REG32   EMAC_TSR;     /**< \brief (Emac Offset: 0x14) Transmit Status Register */
  CPU_REG32   EMAC_RBQP;    /**< \brief (Emac Offset: 0x18) Receive Buffer Queue Pointer Register */
  CPU_REG32   EMAC_TBQP;    /**< \brief (Emac Offset: 0x1C) Transmit Buffer Queue Pointer Register */
  CPU_REG32   EMAC_RSR;     /**< \brief (Emac Offset: 0x20) Receive Status Register */
  CPU_REG32   EMAC_ISR;     /**< \brief (Emac Offset: 0x24) Interrupt Status Register */
  CPU_REG32   EMAC_IER;     /**< \brief (Emac Offset: 0x28) Interrupt Enable Register */
  CPU_REG32   EMAC_IDR;     /**< \brief (Emac Offset: 0x2C) Interrupt Disable Register */
  CPU_REG32   EMAC_IMR;     /**< \brief (Emac Offset: 0x30) Interrupt Mask Register */
  CPU_REG32   EMAC_MAN;     /**< \brief (Emac Offset: 0x34) Phy Maintenance Register */
  CPU_REG32   EMAC_PTR;     /**< \brief (Emac Offset: 0x38) Pause Time Register */
  CPU_REG32   EMAC_PFR;     /**< \brief (Emac Offset: 0x3C) Pause Frames Received Register */
  CPU_REG32   EMAC_FTO;     /**< \brief (Emac Offset: 0x40) Frames Transmitted Ok Register */
  CPU_REG32   EMAC_SCF;     /**< \brief (Emac Offset: 0x44) Single Collision Frames Register */
  CPU_REG32   EMAC_MCF;     /**< \brief (Emac Offset: 0x48) Multiple Collision Frames Register */
  CPU_REG32   EMAC_FRO;     /**< \brief (Emac Offset: 0x4C) Frames Received Ok Register */
  CPU_REG32   EMAC_FCSE;    /**< \brief (Emac Offset: 0x50) Frame Check Sequence Errors Register */
  CPU_REG32   EMAC_ALE;     /**< \brief (Emac Offset: 0x54) Alignment Errors Register */
  CPU_REG32   EMAC_DTF;     /**< \brief (Emac Offset: 0x58) Deferred Transmission Frames Register */
  CPU_REG32   EMAC_LCOL;    /**< \brief (Emac Offset: 0x5C) Late Collisions Register */
  CPU_REG32   EMAC_ECOL;    /**< \brief (Emac Offset: 0x60) Excessive Collisions Register */
  CPU_REG32   EMAC_TUND;    /**< \brief (Emac Offset: 0x64) Transmit Underrun Errors Register */
  CPU_REG32   EMAC_CSE;     /**< \brief (Emac Offset: 0x68) Carrier Sense Errors Register */
  CPU_REG32   EMAC_RRE;     /**< \brief (Emac Offset: 0x6C) Receive Resource Errors Register */
  CPU_REG32   EMAC_ROV;     /**< \brief (Emac Offset: 0x70) Receive Overrun Errors Register */
  CPU_REG32   EMAC_RSE;     /**< \brief (Emac Offset: 0x74) Receive Symbol Errors Register */
  CPU_REG32   EMAC_ELE;     /**< \brief (Emac Offset: 0x78) Excessive Length Errors Register */
  CPU_REG32   EMAC_RJA;     /**< \brief (Emac Offset: 0x7C) Receive Jabbers Register */
  CPU_REG32   EMAC_USF;     /**< \brief (Emac Offset: 0x80) Undersize Frames Register */
  CPU_REG32   EMAC_STE;     /**< \brief (Emac Offset: 0x84) SQE Test Errors Register */
  CPU_REG32   EMAC_RLE;     /**< \brief (Emac Offset: 0x88) Received Length Field Mismatch Register */
  CPU_REG32   Reserved2[1];
  CPU_REG32   EMAC_HRB;     /**< \brief (Emac Offset: 0x90) Hash Register Bottom [31:0] Register */
  CPU_REG32   EMAC_HRT;     /**< \brief (Emac Offset: 0x94) Hash Register Top [63:32] Register */
  CSP_EMAC_SA_REG_TAG  EMAC_SA[CSP_EMAC_SA_NBR_MAX]; /**< \brief (Emac Offset: 0x98) sa = 1 .. 4 */
  CPU_REG32   EMAC_TID;     /**< \brief (Emac Offset: 0xB8) Type ID Checking Register */
  CPU_REG32   Reserved3[1];
  CPU_REG32   EMAC_USRIO;   /**< \brief (Emac Offset: 0xC0) User Input/Output Register */
} CSP_EMAC_REG_TAG, *CSP_EMAC_REG_TAG_PTR;
...
#endif                                                          /* End of CSP_EMAC module include.                      */
