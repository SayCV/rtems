...
typedef struct {
  volatile uint32_t cr;         /**< \brief (Usart Offset: 0x0000) Control Register */
  volatile uint32_t mr;         /**< \brief (Usart Offset: 0x0004) Mode Register */
  volatile uint32_t ier;        /**< \brief (Usart Offset: 0x0008) Interrupt Enable Register */
  volatile uint32_t idr;        /**< \brief (Usart Offset: 0x000C) Interrupt Disable Register */
  volatile uint32_t imr;        /**< \brief (Usart Offset: 0x0010) Interrupt Mask Register */
  volatile uint32_t csr;        /**< \brief (Usart Offset: 0x0014) Channel Status Register */
  volatile uint32_t rhr;        /**< \brief (Usart Offset: 0x0018) Receiver Holding Register */
  volatile uint32_t thr;        /**< \brief (Usart Offset: 0x001C) Transmitter Holding Register */
  volatile uint32_t brgr;       /**< \brief (Usart Offset: 0x0020) Baud Rate Generator Register */
  volatile uint32_t rtor;       /**< \brief (Usart Offset: 0x0024) Receiver Time-out Register */
  volatile uint32_t ttgr;       /**< \brief (Usart Offset: 0x0028) Transmitter Timeguard Register */
  ...
  volatile uint32_t reserved2[34];
  volatile uint32_t wpmr;       /**< \brief (Usart Offset: 0xE4) Write Protect Mode Register */
  volatile uint32_t wpsr;       /**< \brief (Usart Offset: 0xE8) Write Protect Status Register */
} at91_usart_t;
