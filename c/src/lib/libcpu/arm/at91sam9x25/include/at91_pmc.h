...
typedef struct at91_pmc {
	uint32_t	scer;		/* 0x00 System Clock Enable Register */
	uint32_t	scdr;		/* 0x04 System Clock Disable Register */
	uint32_t	scsr;		/* 0x08 System Clock Status Register */
	uint32_t	reserved0;
	uint32_t	pcer;		/* 0x10 Peripheral Clock Enable Register */
	uint32_t	pcdr;		/* 0x14 Peripheral Clock Disable Register */
	uint32_t	pcsr;		/* 0x18 Peripheral Clock Status Register */
	uint32_t	reserved1;
	uint32_t	mor;		/* 0x20 Main Oscilator Register */
	uint32_t	mcfr;		/* 0x24 Main Clock Frequency Register */
	uint32_t	pllar;		/* 0x28 PLL A Register */
	uint32_t	pllbr;		/* 0x2C PLL B Register */
	uint32_t	mckr;		/* 0x30 Master Clock Register */
	uint32_t	reserved2[3];
	uint32_t	pck[4];		/* 0x40 Programmable Clock Register 0 - 3 */
	uint32_t	reserved3[4];
	uint32_t	ier;		/* 0x60 Interrupt Enable Register */
	uint32_t	idr;		/* 0x64 Interrupt Disable Register */
	uint32_t	sr;		/* 0x68 Status Register */
	uint32_t	imr;		/* 0x6C Interrupt Mask Register */
	uint32_t	reserved4[4];
	uint32_t	pllicpr;	/* 0x80 Change Pump Current Register (SAM9) */
	uint32_t	reserved5[21];
	uint32_t	wpmr;		/* 0xE4 Write Protect Mode Register (CAP0) */
	uint32_t	wpsr;		/* 0xE8 Write Protect Status Register (CAP0) */
